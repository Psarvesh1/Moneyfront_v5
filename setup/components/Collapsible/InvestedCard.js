...
export const InvestedCard = ({ Scheme, TotalAmount, InvestedAmount, RedeemedAmount, PresentUnits, AvgPrice, PresentValue, UnRealisedGainLoss, RealisedGainLoss, XIRR, AbsoluteReturn, WeightedAvgDays }) => {
